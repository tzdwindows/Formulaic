...
Result<void> BytecodeCompiler::compile_node(const ASTNode& node) {
    ...
    if (const auto* fn = dynamic_cast<const FunctionCallNode*>(&node)) {
        ...
        else if (name == "asinh" || name == "arsinh") emit(Opcode::ASINH);
        else if (name == "acosh" || name == "arcosh") emit(Opcode::ACOSH);
        else if (name == "atanh" || name == "artanh") emit(Opcode::ATANH);
        else if (name == "sec") emit(Opcode::SEC);
        else if (name == "csc") emit(Opcode::CSC);
        else if (name == "cot") emit(Opcode::COT);
        else if (name == "asec") emit(Opcode::ASEC);
        else if (name == "acsc") emit(Opcode::ACSC);
        else if (name == "acot") emit(Opcode::ACOT);
        else if (name == "sech") emit(Opcode::SECH);
        else if (name == "csch") emit(Opcode::CSCH);
        else if (name == "coth") emit(Opcode::COTH);
        else if (name == "sinc") emit(Opcode::SINC);
        else if (name == "erf") emit(Opcode::ERF);
        else if (name == "erfc") emit(Opcode::ERFC);
        else if (name == "gamma" || name == "tgamma") emit(Opcode::TGAMMA);
        else if (name == "lgamma") emit(Opcode::LGAMMA);
        else if (name == "beta") emit(Opcode::BETA);
        else if (name == "exp") emit(Opcode::EXP);
        else if (name == "exp2") emit(Opcode::EXP2);
        else if (name == "expm1") emit(Opcode::EXPM1);
        else if (name == "ln" || name == "log") emit(Opcode::LN);
        else if (name == "log10") emit(Opcode::LOG10);
        else if (name == "log2") emit(Opcode::LOG2);
        else if (name == "log1p") emit(Opcode::LOG1P);
        ...
        else if (name == "trunc") emit(Opcode::TRUNC);
        else if (name == "frac" || name == "fract") emit(Opcode::FRACT);
        else if (name == "sign") emit(Opcode::SIGN);
        else if (name == "heaviside") emit(Opcode::HEAVISIDE);
        else if (name == "rect") emit(Opcode::RECT);
        else if (name == "tri") emit(Opcode::TRI);
        else if (name == "deg2rad" || name == "radians") emit(Opcode::DEG2RAD);
        else if (name == "rad2deg" || name == "degrees") emit(Opcode::RAD2DEG);
        else if (name == "min") emit(Opcode::MIN);
        else if (name == "max") emit(Opcode::MAX);
        else if (name == "hypot") emit(Opcode::HYPOT);
        else if (name == "copysign") emit(Opcode::COPYSIGN);
        else if (name == "fmod" || name == "mod") emit(Opcode::MOD);
        else if (name == "remainder" || name == "rem") emit(Opcode::REMAINDER);
        else if (name == "step") emit(Opcode::STEP);
